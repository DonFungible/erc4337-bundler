...
export class ERC4337EthersSigner extends Signer {
    ...
    async sendTransaction(
        ...
        const tx: TransactionRequest = await this.populateTransaction(
            transaction
        );
    ...
    async verifyAllNecessaryFields(
        ...
        if (
            transactionRequest.data == null &&
            transactionRequest.value == null
        ) {
    ...
    async signTypedData(signer: any, typedData: any) {
